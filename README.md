...
<head>
    ...
    <title>Ayanda Nsibande | Data Analysis Portfolio</title>
...
<header>
    <div class="container">
        ...
        <div class="social-links">
            ...
            <a href="https://github.com/Ayanda-Nsibande" target="_blank" title="GitHub"><i class="fab fa-github"></i></a>
            <a href="assets/AyandaNsibande.pdf" download title="Download CV"><i class="fas fa-file-arrow-down"></i></a>
        </div>
    </div>
</header>
...
<section id="about" class="section">
    <div class="container">
        ...
        <div class="about-content">
            ...
            <img src="assets/images/profile-placeholder.jpg" alt="Ayanda" class="profile-photo">
            <div class="about-text">
                <!--💡UPDATE: Write your own 'About Me' text here-->
                <p> I am a data professional skilled in converting complex datasets into meaningful insights through interactive visualizations and data storytelling, enabling organizations to make better-informed decisions.</p>
                <p>With experience in Power BI and SQL I specialize in developing comprehensive reports that reveal hidden patterns and trends in data. This portfolio showcases my projects across various sectors.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="contact" class="section">
    <div class="container">
        ...
        <form action="https://formsubmit.co/ayandazamaswazi62@gmail.com" method="POST" class="contact-form">
...
<footer>
    <div class="container">
        ...
        <p>&copy; 2025 Ayanda Nsibande. All rights reserved.</p>
    </div>
</footer>
